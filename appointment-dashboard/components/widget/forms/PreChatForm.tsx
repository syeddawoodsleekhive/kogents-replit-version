...
const PreChatForm = ({ settings }: IPreChatFormProps) => {
  return (
    <>
      <form className="flex flex-col justify-between w-full h-full">
        ...
        <div className="flex flex-col space-y-4 px-5 py-4 overflow-y-auto h-[47dvh]">
          <p className="text-gray-400 text-sm">
            {settings.content.preChatForm.greetingsMessage}
          </p>
          {/* Text or Email Field */}
          <div className="flex flex-col space-y-2">
            <div className="flex flex-col space-y-2">
              <Label className="flex items-center gap-1">
                Name
                {!settings.content.preChatForm.isIdentityRequired && (
          ...
          <div className="flex flex-col space-y-2">
            <Label className="flex items-center gap-1">
              Phone Number
              {!settings.content.preChatForm.isPhoneRequired && (
                <span className="text-xs">(optional)</span>
              )}
            </Label>
            <Input
          ...
          <div className="flex flex-col space-y-2">
            <Label className="flex items-center gap-1">
              Question
              {!settings.content.preChatForm.isQuestionRequired && (
                <span className="text-xs">(optional)</span>
              )}
            </Label>
            <textarea
