...
interface EditTriggerDialogProps {
  ...
  onSubmit: (id: string, updates: Partial<Trigger>) => Promise<void>;
  onTestWebhook?: (
...
export function EditTriggerDialog({
  ...
  const handleSubmit = async () => {
    if (!trigger || !validateForm()) return;

    setLoading(true);
    try {
      await onSubmit(trigger.id, {
        name: formData.name,
        ...
        <div className="space-y-6">
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-2">
              ...
              />
              <Label htmlFor="enabled">Enable this trigger</Label>
            </div>
          </div>
